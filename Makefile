...
UNREALROOTPATH = /mnt/user/salem/UnrealNvme/00-unreal_engine_root/UnrealEngine/5.2.1
GAMEPROJECTFILE =/mnt/user/salem/UnrealNvme/01-unreal_engine_projects/Alif/Alif.uproject
...
TARGETS = \
	...
	UnrealServer \
	Alif-Linux-Debug  \
	Alif-Linux-DebugGame  \
	Alif-Linux-Test  \
	Alif-Linux-Shipping  \
	Alif \
	AlifEditor-Linux-Debug  \
	AlifEditor-Linux-DebugGame  \
	AlifEditor-Linux-Test  \
	AlifEditor-Linux-Shipping  \
	AlifEditor\
	configure
...
StandardSet: RequiredTools UnrealFrontend AlifEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug AlifEditor-Linux-Debug
...
Alif-Linux-Debug:
	 $(PROJECTBUILD) Alif Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Alif-Linux-DebugGame:
	 $(PROJECTBUILD) Alif Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Alif-Linux-Test:
	 $(PROJECTBUILD) Alif Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Alif-Linux-Shipping:
	 $(PROJECTBUILD) Alif Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Alif:
	 $(PROJECTBUILD) Alif Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlifEditor-Linux-Debug:
	 $(PROJECTBUILD) AlifEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlifEditor-Linux-DebugGame:
	 $(PROJECTBUILD) AlifEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlifEditor-Linux-Test:
	 $(PROJECTBUILD) AlifEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlifEditor-Linux-Shipping:
	 $(PROJECTBUILD) AlifEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlifEditor:
	 $(PROJECTBUILD) AlifEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
